...
namespace CodingChallenges.Problems.ArrayProblems.Unsorted.SubArray
{
    internal class _13_LongestSubArrayContainsOnly1ByFlippingK0s
    {
        ...
        public void Run()
        {
            ...
            {
                var result = _testCase.Key
                    .FindLengthOfLongestSubArrayContainsOnly1ByFlippingK0s(_testCase.Value);
                Console.WriteLine($"The length of the longest sub-array that contains only '1's with {_testCase.Value} flipping times of '0' is {result}");
            }
        }
    }
}
