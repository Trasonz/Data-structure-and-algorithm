...
internal class SubArraysSumEqualsK
{
    ...
    [
        new() { ArrayOfElements1 = [1,-1,3,-2,1], Integer1 = 1 },
        new() { ArrayOfElements1 = [1,3,-4,7,2,-2,2,-4,4], Integer1 = 3 },
        new() { ArrayOfElements1 = [1,-1,0], Integer1 = 0 },
        new() { ArrayOfElements1 = [1,1,1], Integer1 = 2 },
        new() { ArrayOfElements1 = [1,2,3], Integer1 = 3 },
    ];
    ...
    public static void Run()
    {
        ...
        {
            Console.WriteLine(FindSubArraysSumEqualsKUsingPrefixSumAndHashMap(testCase.ArrayOfElements1, testCase.Integer1));
        }
    }
}
